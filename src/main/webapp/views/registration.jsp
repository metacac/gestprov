...
<main class="container2" id="main-body">
    <form method="POST" action="/Customer/register" class="registro" id="regsitro">
...
<%
    ...
    if (isMessRegistered){
%>
            <div class="alert alert-success alert-dimissible fade show d-flex justify-content-around" role="alert">
...
%>
            ...
            <section class="row">
                <div class="col" id="container2a">
                    <p>Apellidos y Nombres de la persona contacto</p>
                ...
                <div class="col">
                    <p>Teléfono celular de la persona contacto</p>
                    <p style="font-size: 11px; color:gray">CÓDIGO DE ÁREA Y NÚMERO SIN ESPACIOS EJEM 91112345678</p>
                    <input type="number" name="celular" class="form-control" placeholder="Teléfono celular" aria-label="Teléfono celular" id="celular" required="required"/>
                    <span class="error" aria-live="polite" style="color: red"></span>
                </div>
            </section>
            <section class="row">
                ...
                <div class="col">
<!--                    <span class="material-icons-outlined">e92d</span>  e92d check_circle 
                    <span class="error" aria-live="polite" style="color: red"></span>
                    <span class="material-icons-outlined">cancel</span>  e92d cancel -->
                <div>
                <div class="col">
                    <p>Repita, por favor, su contraseña</p>
